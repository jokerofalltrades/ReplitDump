...
def print(input, timemodifier=1):
...
def viewTrinkets(trinkets, flips, rubikssolved, money) -> int:
    ...
    while True:
        ...
        print("Packsy: You wish to know more about your trinkets... Sure!",8)
        ...
        if response == "1" and items[0] != "???":
            ...
            print("Packsy: 'The spider eye is an eye from a spider. It gleams and glistens with a deep red colour in the light. Utterly Disgusting.'",12)
            ...
            print("Packsy: Let me read you an exercpt from its description...")            
            print("Packsy: 'This poster inspires any and all gamblers to Keep on Flipping.'",12)
            tempresponse = input("Packsy: Inspiring, isn't it! Press enter to continue playing, or type 1 to find out about another trinket. ")
        elif response == "3" and items[2] != "???":
            print("Packsy: So, you wish to find out about the Rubik's Cube Keychain?")            
            print("Packsy: Let me read you an exercpt from its description...")            
            print("Packsy: 'Puzzling, isn't it. This cube has stumped many countless minds for decades. The one who solves it must be a nerd.'",12)
            if rubiksdialogue == 0:
                rubiksdialogue = 1
                print("Packsy: Inspiring, isn't it! Press enter to continue playing, or type 1 to find out about another trinket. ",4)
                print("Packsy: Wait? Another Dialogue Option!",6)
            ...
            if items[3] == "Half-Eaten Waffle":
                ...
                print("Packsy: Euhhh... That stinks. 'A half-eaten, moldy waffle. It stinks really badly...' Euhhh, my eyes are watering.",12)
            tempresponse = input("Packsy: Inspiring, isn't it! Press enter to continue playing, or type 1 to find out about another trinket. ")
        elif response == "5" and items[4] != "???":
            print("Packsy: So, you wish to find out about the Golden Spear?")            
            print("Packsy: Let me read you an exercpt from its description...")            
            print("Packsy: 'A Golden Spear, thousands of years old. Its handle and blade have been meticulously crafted to ensure a sharp edge.'",12)
            tempresponse = input("Packsy: Inspiring, isn't it! Press enter to continue playing, or type 1 to find out about another trinket. ")
            ...
            print("The Flipper: Keep your mouth shut. If you want to li- be my friend.",4)
            print("Packsy: ...")            
            print("Packsy: Let me read you an exercpt from its description then...")            
            print("Packsy: 'The Old Man's Skeleton. Comprised of 206 bones.'",8)
            print("Packsy: Hold up. I think I see something written on the skeleton.",8)
        ...
        if tempresponse == "2" and response == "3":
            if rubikssolved == 0:
                rubikssolved = 1
                print("Packsy: You want to solve it? Here!",12)
        ...
        if tempresponse == "2" and response == "6":
            print("Packsy: Let's have a closer look shall we...",2)
            print("Packsy: *inaudible muttering*",6)
            print("Packsy: Oh! There! Look! It's a... poem?",2)            
            print("Packsy: 'Mold makes watery eyes\nand spears do make HIM cry\nand just 2g of cyanide to make HIM die'",12)
            print("Packsy: Interesting... Ominous... I wonder who they're talking about when the say HIM...",8)
...
def main():
    ...
    while money > 0:
        ...
        print("The Flipper: Do you want to bet on heads, tails, or landing on its edge?",0)
        ...
        if random.randint(1,50) == 50:
            if oldManEncounters == 0:
                print("???: Psst... Hey Kid!",4)
                print("Wise Old Man: Kid, don't bet on edge, the odds are 1 in 5000!",4)
                print("Wise Old Man: These yung'uns could really use some help...",2)
                oldManEncounters += 1
            elif oldManEncounters == 1:
                print("Wise Old Man: Bet heads next time.",4)
                print("Wise Old Man: I promise you will win.",4)
                print("Wise Old Man: Give it everything you have.",2)
                oldManPower = 1
                oldManEncounters += 1
            elif oldManEncounters == 2:
                print("Wise Old Man: The Flipper is trying to 73696C656E6365 me.",4)
                print("Wise Old Man: I don't have long before I'm 676F6E650A.",4)
                print("Wise Old Man: Good Luck and bet on 6865616473 for the next 7468726565 goes.",4)
                oldManEncounters += 1
                oldManPower = 3
            elif oldManEncounters == 3:
                print("Old Man: Kid, I don't have lon-",4)
                print("The Flipper: Enough of this.",4)
                print("The Flipper: This knife'll do the trick...",4)
                print("*A curtain is drawn and st*bbing sounds are heard. When the curtain is pulled, the old man is nowhere to be seen.*",4)
                print("The Flipper: Good. Shall we continue?",4)
                oldManEncounters += 1
        #wise messenger
        if oldManEncounters >= 4 and flips >= 700 + (50 * wiseMessengerEncounters):
            if wiseMessengerEncounters == 0:
                print("???: You haven't met me before have you?",4)                
                print("???: I've been brought here to free you from this loop.",4)                
                print("Wise Messenger: I am the Wise Messenger.",4)
                wiseMessengerEncounters += 1
            elif wiseMessengerEncounters == 1:
                print("Wise Messenger: Why should you want escape you may ask...",4)                
                print("Wise Messenger: You see, HE is evil. He's in it for the money only.",4)                
                print("Wise Messenger: There's an old tale that his servant has killed more than 500 'robbers' as HE calls them.",4)                
                print("Wise Messenger: Be Back Soon.",4)
                wiseMessengerEncounters += 2
            elif wiseMessengerEncounters == 3:
                print("Wise Messenger: If you want to escape his clutches, you will have to kill him.",4)            
                print("Wise Messenger: I can help out with this quest but you will have to do the killing yourself.",4)                
                #Key Event
                ...
                print("Wise Messenger: Listen it would be better for both of us if you joined me to slay HIM.",4)                
                wiseMessengerHelp = input("Wise Messenger: So, do you want to join me and slay HIM once and for all. (Yes or No) ")
                if wiseMessengerHelp.lower() == "yes":
                    wiseMessengerEncounters = 3.4
                else:
                    print("Wise Messenger: If you so wish, I shall leave you to it. Enjoy being HIS puppet.",4)
    ...
    if killScene == 1 and money > 100:
        print("*As you begin to walk away you hear The Flipper bark orders at his servant.*",4)
        print("Servant: Must I?",4)
        print("*Suddenly you feel a sharp pain in the back of your head and you fall to the floor.*",8)
        print("The Flipper: The house. Always. WINS.",4)
        print("*As you feel yourself slipping away, The Flipper approaches and takes all your flipcoin, all the while with a manic smile.*",0)
    elif money > 0:
        print("The Flipper: Thanks for playing! See you again soon!",0)
    else:
        print("The Flipper: What a disappointing end...",2)        
        print("The Flipper: Thanks for your money.",0)
